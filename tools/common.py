...
def calc_overlay_position(
    ...
    positions = {
        ...
        "bottom-center-6": ((base_width - overlay_width) // 2, base_height * 5 // 6 - overlay_height // 2),
        "bottom-center-7": ((base_width - overlay_width) // 2, base_height * 6 // 7 - overlay_height // 2),
